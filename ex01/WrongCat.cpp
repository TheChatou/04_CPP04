...
WrongCat::WrongCat(): WrongAnimal()
{
	...
	std::cout << GREEN_ITALIC << "^ Default Constructor" << RESET << std::endl;
}

WrongCat::WrongCat(const WrongCat &copy)
{
	*this = copy;
	std::cout << GREEN_ITALIC << "> Copy Constructor" << RESET << std::endl;
}

WrongCat::~WrongCat()
{
	std::cout << GREEN_ITALIC << "x Destructor" << RESET << std::endl;
}
