...
WrongAnimal::WrongAnimal(): _type("NoType")
{
	...
	std::cout << std::endl << MAGENTA_ITALIC <<  "^ Default Constructor" << RESET << std::endl;
}

WrongAnimal::WrongAnimal(const WrongAnimal &copy): _type(copy._type)
{
	*this = copy;
	std::cout << MAGENTA_ITALIC << "> Copy Constructor" << RESET << std::endl;
}

WrongAnimal::~WrongAnimal()
{
	std::cout << MAGENTA_ITALIC << "x Destructor" << RESET << std::endl << std::endl;
}
...
{
	std::cout << MAGENTA_ITALIC << "-- NooOOooise --" << RESET << std::endl;
}
